    ...
    return ( 
        <div className="wishcard">
            ...
            <div className="add__to__cart">
                <Button variant='outlined' onClick={handelAddToCart} sx={[{'&:hover': { backgroundColor: '#f40000', borderColor: '#f40000', color: 'black'}, borderColor: 'black', backgroundColor: "black" , color: "#f40000"}]}>Add to cart</Button>
            </div>
        </div>
     );
}
